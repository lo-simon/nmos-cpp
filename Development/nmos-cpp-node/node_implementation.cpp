...
{
    return [&resources, &gate](nmos::experimental::control_protocol_state& control_protocol_state, const nmos::resource& resource, bool recurse)
    {
...
{
    return [&resources, &gate](nmos::experimental::control_protocol_state& control_protocol_state, const nmos::resource& resource, const web::json::value& backup_data_set, bool recurse, const web::json::array& included_property_traits)
    {
...
{
    return [&resources, &gate](nmos::experimental::control_protocol_state& control_protocol_state, const nmos::resource& resource, const web::json::value& data_set, bool recurse, const web::json::array& included_property_traits)
    {
