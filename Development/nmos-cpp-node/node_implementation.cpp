...
{
    return [&resources, &gate](const nmos::resource& resource, const web::json::value& backup_data_set, bool recurse, const web::json::array& included_property_traits)
    {
...
{
    return [&resources, &gate](const nmos::resource& resource, const web::json::value& data_set, bool recurse, const web::json::array& included_property_traits)
    {
