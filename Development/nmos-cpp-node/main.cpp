...
// Note: the get_ocsp_response callback must be set up before executing the make_node_server where make_http_listener_config is set up
        ...
        nmos::experimental::control_protocol_state control_protocol_state(node_implementation.control_protocol_property_changed, node_implementation.get_properties_by_path_method_handler, node_implementation.validate_set_properties_by_path_method_handler, node_implementation.set_properties_by_path_method_handler);
