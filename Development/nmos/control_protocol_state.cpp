...
namespace nmos
{
    namespace experimental
    {
        ...
        namespace details
        {
            ...
            nmos::experimental::control_protocol_method_handler make_nc_get_properties_by_path_handler(nmos::experimental::control_protocol_state& control_protocol_state, get_properties_by_path_handler get_properties_by_path)
            {
                return [&control_protocol_state, get_properties_by_path](nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
                {
                    ...
                    {
                        result = get_properties_by_path(control_protocol_state, resource, recurse);
            ...
            nmos::experimental::control_protocol_method_handler make_nc_validate_set_properties_by_path_handler(nmos::experimental::control_protocol_state& control_protocol_state, validate_set_properties_by_path_handler validate_set_properties_by_path)
            {
                return [&control_protocol_state, validate_set_properties_by_path](nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
                {
                    bool recurse = nmos::fields::nc::recurse(arguments);
                    ...
                    {
                        result = validate_set_properties_by_path(control_protocol_state, resource, data_set, recurse, included_property_traits);
            ...
            nmos::experimental::control_protocol_method_handler make_nc_set_properties_by_path_handler(nmos::experimental::control_protocol_state& control_protocol_state, set_properties_by_path_handler set_properties_by_path)
            {
                return [&control_protocol_state, set_properties_by_path](nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
                {
                    bool recurse = nmos::fields::nc::recurse(arguments);
                    const auto& included_property_traits = nmos::fields::nc::included_property_traits(arguments);
                    const auto& data_set = nmos::fields::nc::data_set(arguments);
                    ...
                    {
                        result = set_properties_by_path(control_protocol_state, resource, data_set, recurse, included_property_traits);
        ...
        control_protocol_state::control_protocol_state(control_protocol_property_changed_handler property_changed, get_properties_by_path_handler get_properties_by_path, validate_set_properties_by_path_handler validate_set_properties_by_path, set_properties_by_path_handler set_properties_by_path)
        {
            ...
            control_class_descriptors =
            {
                ...
                { nc_bulk_properties_manager_class_id, make_control_class_descriptor(U("NcBulkPropertiesManager class descriptor"), nc_bulk_properties_manager_class_id, U("NcBulkPropertiesManager"), U("BulkPropertiesManager"),
                    ...
                    {
                        { nc_bulk_properties_manager_get_properties_by_path_method_id, details::make_nc_get_properties_by_path_handler(*this, get_properties_by_path) },
                        { nc_bulk_properties_manager_validate_set_properties_by_path_method_id, details::make_nc_validate_set_properties_by_path_handler(*this, validate_set_properties_by_path) },
                        { nc_bulk_properties_manager_set_properties_by_path_method_id, details::make_nc_set_properties_by_path_handler(*this, set_properties_by_path) }
                    }),
