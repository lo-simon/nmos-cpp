...
namespace nmos
{
    namespace experimental
    {
        ...
        struct control_protocol_state
        {
            ...
            control_protocol_state(control_protocol_property_changed_handler property_changed = nullptr, control_protocol_method_handler get_properties_by_path_method_handler = nullptr, control_protocol_method_handler validate_set_properties_by_path_method_handler = nullptr, control_protocol_method_handler set_properties_by_path_method_handler = nullptr);
